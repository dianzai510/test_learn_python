...
def detect(opt):
    datasets_test = data_srcnn("D:/work/files/deeplearn_datasets/test_datasets/gen_xray/out/super_train")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', default='run/train/srcnn/weights/best.pth')
