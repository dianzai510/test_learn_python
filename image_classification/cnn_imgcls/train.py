...
from image_classification.cnn_imgcls.data import data_xray_sot23, data_xray_sc88, data_xray_sc70, data_xray_sc89, \
    data_xray_sod123, data_xray_sod323, data_xray_sot23_juanpan, data_xray_sod523, data_xray_sod723
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', default='run/train/exp_xray_sod723/weights/best.pth',  # 修改
                        help='指定权重文件，未指定则使用官方权重！')
    parser.add_argument('--resume', default=False, type=bool,
                        help='True表示从--weights参数指定的epoch开始训练,False从0开始')
    parser.add_argument('--data', default=data_xray_sod723)  # 修改

    parser.add_argument('--epoch', default='400', type=int)
    parser.add_argument('--lr', default=0.01, type=float)
    parser.add_argument('--batch_size', default=60, type=int)
    parser.add_argument('--out_path', default='run/train/exp_xray_sod723', type=str)  # 修改
